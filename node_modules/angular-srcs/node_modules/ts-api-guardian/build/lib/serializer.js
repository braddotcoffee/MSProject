...
var ResolvedDeclarationEmitter = (function () {
    ...
    ResolvedDeclarationEmitter.prototype.emit = function () {
        ...
        for (var _i = 0; _i < resolvedSymbols.length; _i++) {
            var symbol = resolvedSymbols[_i];
            ...
            // upwards.
            while (!(decl.flags & 1 /* Export */) && decl.parent) {
                decl = decl.parent;
            }
            if (decl.flags & 1 /* Export */) {
                    ...
                    case 215 /* InterfaceDeclaration */: {
                        ...
                        if (children.every(function (node) { return node.kind in memberDeclarationOrder; })) {
                            ...
                            children.sort(function (a, b) {
                                // Static after normal
                                return compareFunction(a.flags & 128 /* Static */, b.flags & 128 /* Static */) ||
...
var memberDeclarationOrder = (_a = {},
    _a[140 /* PropertySignature */] = 0,
    _a[141 /* PropertyDeclaration */] = 0,
    _a[145 /* GetAccessor */] = 0,
    _a[146 /* SetAccessor */] = 0,
    _a[147 /* CallSignature */] = 1,
    _a[144 /* Constructor */] = 2,
    _a[148 /* ConstructSignature */] = 2,
    _a[149 /* IndexSignature */] = 3,
    _a[142 /* MethodSignature */] = 4,
    _a[143 /* MethodDeclaration */] = 4,
    _a
);
...
function getFirstQualifier(node) {
    if (node.kind === 166 /* PropertyAccessExpression */) {
        // For expression position
        var lhs = node;
        do {
            lhs = lhs.expression;
        } while (lhs && lhs.kind !== 69 /* Identifier */);
        return lhs;
    }
    else if (node.kind === 151 /* TypeReference */) {
        // For type position
